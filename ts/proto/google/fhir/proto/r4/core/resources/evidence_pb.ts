...
export class Evidence extends Message<Evidence> {
  ...
  static readonly typeName = "google.fhir.r4.core.Evidence";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 17, name: "status", kind: "message", T: Evidence_StatusCode },
 ...
 */
export class Evidence_StatusCode extends Message<Evidence_StatusCode> {
  /**
  ...
  constructor(data?: PartialMessage<Evidence_StatusCode>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.Evidence.StatusCode";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Evidence_StatusCode {
    return new Evidence_StatusCode().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Evidence_StatusCode {
    return new Evidence_StatusCode().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Evidence_StatusCode {
    return new Evidence_StatusCode().fromJsonString(jsonString, options);
  }

  static equals(a: Evidence_StatusCode | PlainMessage<Evidence_StatusCode> | undefined, b: Evidence_StatusCode | PlainMessage<Evidence_StatusCode> | undefined): boolean {
    return proto3.util.equals(Evidence_StatusCode, a, b);
  }
}
