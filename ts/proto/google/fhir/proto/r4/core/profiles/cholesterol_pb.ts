...
// @generated from file proto/google/fhir/proto/r4/core/profiles/cholesterol.proto (package google.fhir.r4.core, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message google.fhir.r4.core.Cholesterol
 */
export class Cholesterol extends Message<Cholesterol> {
  ...
  /**
   * @generated from field: google.fhir.r4.core.Cholesterol.StatusCode status = 13;
   */
  ...
  /**
   * @generated from field: google.fhir.r4.core.Cholesterol.EffectiveX effective = 19;
   */
  ...
  /**
   * @generated from field: google.fhir.r4.core.Cholesterol.ValueX value = 22;
   */
  ...
  /**
   * @generated from field: google.fhir.r4.core.Cholesterol.ReferenceRange reference_range = 30;
   */
  referenceRange?: Cholesterol_ReferenceRange;

  /**
   * @generated from field: repeated google.fhir.r4.core.Cholesterol.Component component = 33;
   */
  ...
  static readonly typeName = "google.fhir.r4.core.Cholesterol";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 13, name: "status", kind: "message", T: Cholesterol_StatusCode },
    ...
    { no: 19, name: "effective", kind: "message", T: Cholesterol_EffectiveX },
    { no: 20, name: "issued", kind: "message", T: Instant },
    { no: 21, name: "performer", kind: "message", T: Reference, repeated: true },
    { no: 22, name: "value", kind: "message", T: Cholesterol_ValueX },
    ...
    { no: 30, name: "reference_range", kind: "message", T: Cholesterol_ReferenceRange },
    { no: 33, name: "component", kind: "message", T: Cholesterol_Component, repeated: true },
  ]);
 ...
 *
 * @generated from message google.fhir.r4.core.Cholesterol.StatusCode
 */
export class Cholesterol_StatusCode extends Message<Cholesterol_StatusCode> {
  /**
  ...
  constructor(data?: PartialMessage<Cholesterol_StatusCode>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.Cholesterol.StatusCode";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Cholesterol_StatusCode {
    return new Cholesterol_StatusCode().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Cholesterol_StatusCode {
    return new Cholesterol_StatusCode().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Cholesterol_StatusCode {
    return new Cholesterol_StatusCode().fromJsonString(jsonString, options);
  }

  static equals(a: Cholesterol_StatusCode | PlainMessage<Cholesterol_StatusCode> | undefined, b: Cholesterol_StatusCode | PlainMessage<Cholesterol_StatusCode> | undefined): boolean {
    return proto3.util.equals(Cholesterol_StatusCode, a, b);
  }
}
 ...
 *
 * @generated from message google.fhir.r4.core.Cholesterol.EffectiveX
 */
export class Cholesterol_EffectiveX extends Message<Cholesterol_EffectiveX> {
  /**
   * @generated from oneof google.fhir.r4.core.Cholesterol.EffectiveX.choice
   */
  choice: {
    /**
  ...
  constructor(data?: PartialMessage<Cholesterol_EffectiveX>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.Cholesterol.EffectiveX";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Cholesterol_EffectiveX {
    return new Cholesterol_EffectiveX().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Cholesterol_EffectiveX {
    return new Cholesterol_EffectiveX().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Cholesterol_EffectiveX {
    return new Cholesterol_EffectiveX().fromJsonString(jsonString, options);
  }

  static equals(a: Cholesterol_EffectiveX | PlainMessage<Cholesterol_EffectiveX> | undefined, b: Cholesterol_EffectiveX | PlainMessage<Cholesterol_EffectiveX> | undefined): boolean {
    return proto3.util.equals(Cholesterol_EffectiveX, a, b);
  }
}
 ...
 * Actual result
 *
 * @generated from message google.fhir.r4.core.Cholesterol.ValueX
 */
export class Cholesterol_ValueX extends Message<Cholesterol_ValueX> {
  /**
   * @generated from oneof google.fhir.r4.core.Cholesterol.ValueX.choice
   */
  choice: {
    /**
  ...
  constructor(data?: PartialMessage<Cholesterol_ValueX>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.Cholesterol.ValueX";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "quantity", kind: "message", T: Quantity, oneof: "choice" },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Cholesterol_ValueX {
    return new Cholesterol_ValueX().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Cholesterol_ValueX {
    return new Cholesterol_ValueX().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Cholesterol_ValueX {
    return new Cholesterol_ValueX().fromJsonString(jsonString, options);
  }

  static equals(a: Cholesterol_ValueX | PlainMessage<Cholesterol_ValueX> | undefined, b: Cholesterol_ValueX | PlainMessage<Cholesterol_ValueX> | undefined): boolean {
    return proto3.util.equals(Cholesterol_ValueX, a, b);
  }
}
 ...
 *
 * @generated from message google.fhir.r4.core.Cholesterol.ReferenceRange
 */
export class Cholesterol_ReferenceRange extends Message<Cholesterol_ReferenceRange> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.Cholesterol.ReferenceRange";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * Component results
 *
 * @generated from message google.fhir.r4.core.Cholesterol.Component
 */
export class Cholesterol_Component extends Message<Cholesterol_Component> {
  ...
  /**
   * @generated from field: google.fhir.r4.core.Cholesterol.Component.ValueX value = 5;
   */
   ...
   *
   * @generated from field: repeated google.fhir.r4.core.Cholesterol.ReferenceRange reference_range = 8;
   */
  referenceRange: Cholesterol_ReferenceRange[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.Cholesterol.Component";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "message", T: String },
    { no: 2, name: "extension", kind: "message", T: Extension, repeated: true },
    { no: 3, name: "modifier_extension", kind: "message", T: Extension, repeated: true },
    { no: 4, name: "code", kind: "message", T: CodeableConcept },
    { no: 5, name: "value", kind: "message", T: Cholesterol_Component_ValueX },
 ...
 *
 * @generated from message google.fhir.r4.core.Cholesterol.Component.ValueX
 */
export class Cholesterol_Component_ValueX extends Message<Cholesterol_Component_ValueX> {
  /**
   * @generated from oneof google.fhir.r4.core.Cholesterol.Component.ValueX.choice
   */
  choice: {
    /**
     * @generated from field: google.fhir.r4.core.Quantity quantity = 1;
  ...
  constructor(data?: PartialMessage<Cholesterol_Component_ValueX>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.Cholesterol.Component.ValueX";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "quantity", kind: "message", T: Quantity, oneof: "choice" },
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Cholesterol_Component_ValueX {
    return new Cholesterol_Component_ValueX().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Cholesterol_Component_ValueX {
    return new Cholesterol_Component_ValueX().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Cholesterol_Component_ValueX {
    return new Cholesterol_Component_ValueX().fromJsonString(jsonString, options);
  }

  static equals(a: Cholesterol_Component_ValueX | PlainMessage<Cholesterol_Component_ValueX> | undefined, b: Cholesterol_Component_ValueX | PlainMessage<Cholesterol_Component_ValueX> | undefined): boolean {
    return proto3.util.equals(Cholesterol_Component_ValueX, a, b);
  }
}
