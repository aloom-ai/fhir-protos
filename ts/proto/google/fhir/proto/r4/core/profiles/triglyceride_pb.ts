...
// @generated from file proto/google/fhir/proto/r4/core/profiles/triglyceride.proto (package google.fhir.r4.core, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message google.fhir.r4.core.Triglyceride
 */
export class Triglyceride extends Message<Triglyceride> {
  ...
  /**
   * @generated from field: google.fhir.r4.core.Triglyceride.StatusCode status = 13;
   */
  ...
  /**
   * @generated from field: google.fhir.r4.core.Triglyceride.EffectiveX effective = 19;
   */
  ...
  /**
   * @generated from field: google.fhir.r4.core.Triglyceride.ValueX value = 22;
   */
  ...
  /**
   * @generated from field: google.fhir.r4.core.Triglyceride.ReferenceRange reference_range = 30;
   */
  referenceRange?: Triglyceride_ReferenceRange;

  /**
   * @generated from field: repeated google.fhir.r4.core.Triglyceride.Component component = 33;
   */
  ...
  static readonly typeName = "google.fhir.r4.core.Triglyceride";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 13, name: "status", kind: "message", T: Triglyceride_StatusCode },
    ...
    { no: 19, name: "effective", kind: "message", T: Triglyceride_EffectiveX },
    { no: 20, name: "issued", kind: "message", T: Instant },
    { no: 21, name: "performer", kind: "message", T: Reference, repeated: true },
    { no: 22, name: "value", kind: "message", T: Triglyceride_ValueX },
    ...
    { no: 30, name: "reference_range", kind: "message", T: Triglyceride_ReferenceRange },
    { no: 33, name: "component", kind: "message", T: Triglyceride_Component, repeated: true },
  ]);
 ...
 *
 * @generated from message google.fhir.r4.core.Triglyceride.StatusCode
 */
export class Triglyceride_StatusCode extends Message<Triglyceride_StatusCode> {
  /**
  ...
  constructor(data?: PartialMessage<Triglyceride_StatusCode>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.Triglyceride.StatusCode";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Triglyceride_StatusCode {
    return new Triglyceride_StatusCode().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Triglyceride_StatusCode {
    return new Triglyceride_StatusCode().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Triglyceride_StatusCode {
    return new Triglyceride_StatusCode().fromJsonString(jsonString, options);
  }

  static equals(a: Triglyceride_StatusCode | PlainMessage<Triglyceride_StatusCode> | undefined, b: Triglyceride_StatusCode | PlainMessage<Triglyceride_StatusCode> | undefined): boolean {
    return proto3.util.equals(Triglyceride_StatusCode, a, b);
  }
}
 ...
 *
 * @generated from message google.fhir.r4.core.Triglyceride.EffectiveX
 */
export class Triglyceride_EffectiveX extends Message<Triglyceride_EffectiveX> {
  /**
   * @generated from oneof google.fhir.r4.core.Triglyceride.EffectiveX.choice
   */
  choice: {
    /**
  ...
  constructor(data?: PartialMessage<Triglyceride_EffectiveX>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.Triglyceride.EffectiveX";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Triglyceride_EffectiveX {
    return new Triglyceride_EffectiveX().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Triglyceride_EffectiveX {
    return new Triglyceride_EffectiveX().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Triglyceride_EffectiveX {
    return new Triglyceride_EffectiveX().fromJsonString(jsonString, options);
  }

  static equals(a: Triglyceride_EffectiveX | PlainMessage<Triglyceride_EffectiveX> | undefined, b: Triglyceride_EffectiveX | PlainMessage<Triglyceride_EffectiveX> | undefined): boolean {
    return proto3.util.equals(Triglyceride_EffectiveX, a, b);
  }
}
 ...
 * Actual result
 *
 * @generated from message google.fhir.r4.core.Triglyceride.ValueX
 */
export class Triglyceride_ValueX extends Message<Triglyceride_ValueX> {
  /**
   * @generated from oneof google.fhir.r4.core.Triglyceride.ValueX.choice
   */
  choice: {
    /**
  ...
  constructor(data?: PartialMessage<Triglyceride_ValueX>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.Triglyceride.ValueX";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "quantity", kind: "message", T: Quantity, oneof: "choice" },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Triglyceride_ValueX {
    return new Triglyceride_ValueX().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Triglyceride_ValueX {
    return new Triglyceride_ValueX().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Triglyceride_ValueX {
    return new Triglyceride_ValueX().fromJsonString(jsonString, options);
  }

  static equals(a: Triglyceride_ValueX | PlainMessage<Triglyceride_ValueX> | undefined, b: Triglyceride_ValueX | PlainMessage<Triglyceride_ValueX> | undefined): boolean {
    return proto3.util.equals(Triglyceride_ValueX, a, b);
  }
}
 ...
 *
 * @generated from message google.fhir.r4.core.Triglyceride.ReferenceRange
 */
export class Triglyceride_ReferenceRange extends Message<Triglyceride_ReferenceRange> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.Triglyceride.ReferenceRange";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * Component results
 *
 * @generated from message google.fhir.r4.core.Triglyceride.Component
 */
export class Triglyceride_Component extends Message<Triglyceride_Component> {
  ...
  /**
   * @generated from field: google.fhir.r4.core.Triglyceride.Component.ValueX value = 5;
   */
   ...
   *
   * @generated from field: repeated google.fhir.r4.core.Triglyceride.ReferenceRange reference_range = 8;
   */
  referenceRange: Triglyceride_ReferenceRange[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.Triglyceride.Component";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "message", T: String },
    { no: 2, name: "extension", kind: "message", T: Extension, repeated: true },
    { no: 3, name: "modifier_extension", kind: "message", T: Extension, repeated: true },
    { no: 4, name: "code", kind: "message", T: CodeableConcept },
    { no: 5, name: "value", kind: "message", T: Triglyceride_Component_ValueX },
 ...
 *
 * @generated from message google.fhir.r4.core.Triglyceride.Component.ValueX
 */
export class Triglyceride_Component_ValueX extends Message<Triglyceride_Component_ValueX> {
  /**
   * @generated from oneof google.fhir.r4.core.Triglyceride.Component.ValueX.choice
   */
  choice: {
    /**
     * @generated from field: google.fhir.r4.core.Quantity quantity = 1;
  ...
  constructor(data?: PartialMessage<Triglyceride_Component_ValueX>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.Triglyceride.Component.ValueX";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "quantity", kind: "message", T: Quantity, oneof: "choice" },
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): Triglyceride_Component_ValueX {
    return new Triglyceride_Component_ValueX().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): Triglyceride_Component_ValueX {
    return new Triglyceride_Component_ValueX().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): Triglyceride_Component_ValueX {
    return new Triglyceride_Component_ValueX().fromJsonString(jsonString, options);
  }

  static equals(a: Triglyceride_Component_ValueX | PlainMessage<Triglyceride_Component_ValueX> | undefined, b: Triglyceride_Component_ValueX | PlainMessage<Triglyceride_Component_ValueX> | undefined): boolean {
    return proto3.util.equals(Triglyceride_Component_ValueX, a, b);
  }
}
