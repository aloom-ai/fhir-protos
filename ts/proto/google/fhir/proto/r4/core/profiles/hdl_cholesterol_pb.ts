...
// @generated from file proto/google/fhir/proto/r4/core/profiles/hdl_cholesterol.proto (package google.fhir.r4.core, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message google.fhir.r4.core.HdlCholesterol
 */
export class HdlCholesterol extends Message<HdlCholesterol> {
  ...
  /**
   * @generated from field: google.fhir.r4.core.HdlCholesterol.StatusCode status = 13;
   */
  ...
  /**
   * @generated from field: google.fhir.r4.core.HdlCholesterol.EffectiveX effective = 19;
   */
  ...
  /**
   * @generated from field: google.fhir.r4.core.HdlCholesterol.ValueX value = 22;
   */
  ...
  /**
   * @generated from field: google.fhir.r4.core.HdlCholesterol.ReferenceRange reference_range = 30;
   */
  referenceRange?: HdlCholesterol_ReferenceRange;

  /**
   * @generated from field: repeated google.fhir.r4.core.HdlCholesterol.Component component = 33;
   */
  ...
  static readonly typeName = "google.fhir.r4.core.HdlCholesterol";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 13, name: "status", kind: "message", T: HdlCholesterol_StatusCode },
    ...
    { no: 19, name: "effective", kind: "message", T: HdlCholesterol_EffectiveX },
    { no: 20, name: "issued", kind: "message", T: Instant },
    { no: 21, name: "performer", kind: "message", T: Reference, repeated: true },
    { no: 22, name: "value", kind: "message", T: HdlCholesterol_ValueX },
    ...
    { no: 30, name: "reference_range", kind: "message", T: HdlCholesterol_ReferenceRange },
    { no: 33, name: "component", kind: "message", T: HdlCholesterol_Component, repeated: true },
  ]);
 ...
 *
 * @generated from message google.fhir.r4.core.HdlCholesterol.StatusCode
 */
export class HdlCholesterol_StatusCode extends Message<HdlCholesterol_StatusCode> {
  /**
  ...
  constructor(data?: PartialMessage<HdlCholesterol_StatusCode>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.HdlCholesterol.StatusCode";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): HdlCholesterol_StatusCode {
    return new HdlCholesterol_StatusCode().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): HdlCholesterol_StatusCode {
    return new HdlCholesterol_StatusCode().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): HdlCholesterol_StatusCode {
    return new HdlCholesterol_StatusCode().fromJsonString(jsonString, options);
  }

  static equals(a: HdlCholesterol_StatusCode | PlainMessage<HdlCholesterol_StatusCode> | undefined, b: HdlCholesterol_StatusCode | PlainMessage<HdlCholesterol_StatusCode> | undefined): boolean {
    return proto3.util.equals(HdlCholesterol_StatusCode, a, b);
  }
}
 ...
 *
 * @generated from message google.fhir.r4.core.HdlCholesterol.EffectiveX
 */
export class HdlCholesterol_EffectiveX extends Message<HdlCholesterol_EffectiveX> {
  /**
   * @generated from oneof google.fhir.r4.core.HdlCholesterol.EffectiveX.choice
   */
  choice: {
    /**
  ...
  constructor(data?: PartialMessage<HdlCholesterol_EffectiveX>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.HdlCholesterol.EffectiveX";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): HdlCholesterol_EffectiveX {
    return new HdlCholesterol_EffectiveX().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): HdlCholesterol_EffectiveX {
    return new HdlCholesterol_EffectiveX().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): HdlCholesterol_EffectiveX {
    return new HdlCholesterol_EffectiveX().fromJsonString(jsonString, options);
  }

  static equals(a: HdlCholesterol_EffectiveX | PlainMessage<HdlCholesterol_EffectiveX> | undefined, b: HdlCholesterol_EffectiveX | PlainMessage<HdlCholesterol_EffectiveX> | undefined): boolean {
    return proto3.util.equals(HdlCholesterol_EffectiveX, a, b);
  }
}
 ...
 * Actual result
 *
 * @generated from message google.fhir.r4.core.HdlCholesterol.ValueX
 */
export class HdlCholesterol_ValueX extends Message<HdlCholesterol_ValueX> {
  /**
   * @generated from oneof google.fhir.r4.core.HdlCholesterol.ValueX.choice
   */
  choice: {
    /**
  ...
  constructor(data?: PartialMessage<HdlCholesterol_ValueX>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.HdlCholesterol.ValueX";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "quantity", kind: "message", T: Quantity, oneof: "choice" },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): HdlCholesterol_ValueX {
    return new HdlCholesterol_ValueX().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): HdlCholesterol_ValueX {
    return new HdlCholesterol_ValueX().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): HdlCholesterol_ValueX {
    return new HdlCholesterol_ValueX().fromJsonString(jsonString, options);
  }

  static equals(a: HdlCholesterol_ValueX | PlainMessage<HdlCholesterol_ValueX> | undefined, b: HdlCholesterol_ValueX | PlainMessage<HdlCholesterol_ValueX> | undefined): boolean {
    return proto3.util.equals(HdlCholesterol_ValueX, a, b);
  }
}
 ...
 *
 * @generated from message google.fhir.r4.core.HdlCholesterol.ReferenceRange
 */
export class HdlCholesterol_ReferenceRange extends Message<HdlCholesterol_ReferenceRange> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.HdlCholesterol.ReferenceRange";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * Component results
 *
 * @generated from message google.fhir.r4.core.HdlCholesterol.Component
 */
export class HdlCholesterol_Component extends Message<HdlCholesterol_Component> {
  ...
  /**
   * @generated from field: google.fhir.r4.core.HdlCholesterol.Component.ValueX value = 5;
   */
   ...
   *
   * @generated from field: repeated google.fhir.r4.core.HdlCholesterol.ReferenceRange reference_range = 8;
   */
  referenceRange: HdlCholesterol_ReferenceRange[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.HdlCholesterol.Component";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "message", T: String },
    { no: 2, name: "extension", kind: "message", T: Extension, repeated: true },
    { no: 3, name: "modifier_extension", kind: "message", T: Extension, repeated: true },
    { no: 4, name: "code", kind: "message", T: CodeableConcept },
    { no: 5, name: "value", kind: "message", T: HdlCholesterol_Component_ValueX },
 ...
 *
 * @generated from message google.fhir.r4.core.HdlCholesterol.Component.ValueX
 */
export class HdlCholesterol_Component_ValueX extends Message<HdlCholesterol_Component_ValueX> {
  /**
   * @generated from oneof google.fhir.r4.core.HdlCholesterol.Component.ValueX.choice
   */
  choice: {
    /**
     * @generated from field: google.fhir.r4.core.Quantity quantity = 1;
  ...
  constructor(data?: PartialMessage<HdlCholesterol_Component_ValueX>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.HdlCholesterol.Component.ValueX";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "quantity", kind: "message", T: Quantity, oneof: "choice" },
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): HdlCholesterol_Component_ValueX {
    return new HdlCholesterol_Component_ValueX().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): HdlCholesterol_Component_ValueX {
    return new HdlCholesterol_Component_ValueX().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): HdlCholesterol_Component_ValueX {
    return new HdlCholesterol_Component_ValueX().fromJsonString(jsonString, options);
  }

  static equals(a: HdlCholesterol_Component_ValueX | PlainMessage<HdlCholesterol_Component_ValueX> | undefined, b: HdlCholesterol_Component_ValueX | PlainMessage<HdlCholesterol_Component_ValueX> | undefined): boolean {
    return proto3.util.equals(HdlCholesterol_Component_ValueX, a, b);
  }
}
