...
// @generated from file proto/google/fhir/proto/r4/core/profiles/cql_library.proto (package google.fhir.r4.core, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message google.fhir.r4.core.CQLLibrary
 */
export class CQLLibrary extends Message<CQLLibrary> {
  /**
  ...
  /**
   * @generated from field: google.fhir.r4.core.CQLLibrary.StatusCode status = 16;
   */
  status?: CQLLibrary_StatusCode;
  ...
  /**
   * @generated from field: google.fhir.r4.core.CQLLibrary.SubjectX subject = 19;
   */
  subject?: CQLLibrary_SubjectX;
  ...
  constructor(data?: PartialMessage<CQLLibrary>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.CQLLibrary";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 16, name: "status", kind: "message", T: CQLLibrary_StatusCode },
    { no: 17, name: "experimental", kind: "message", T: Boolean },
    { no: 18, name: "type", kind: "message", T: CodeableConcept },
    { no: 19, name: "subject", kind: "message", T: CQLLibrary_SubjectX },
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): CQLLibrary {
    return new CQLLibrary().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): CQLLibrary {
    return new CQLLibrary().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): CQLLibrary {
    return new CQLLibrary().fromJsonString(jsonString, options);
  }

  static equals(a: CQLLibrary | PlainMessage<CQLLibrary> | undefined, b: CQLLibrary | PlainMessage<CQLLibrary> | undefined): boolean {
    return proto3.util.equals(CQLLibrary, a, b);
  }
}
 ...
 *
 * @generated from message google.fhir.r4.core.CQLLibrary.StatusCode
 */
export class CQLLibrary_StatusCode extends Message<CQLLibrary_StatusCode> {
  /**
  ...
  constructor(data?: PartialMessage<CQLLibrary_StatusCode>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.CQLLibrary.StatusCode";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): CQLLibrary_StatusCode {
    return new CQLLibrary_StatusCode().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): CQLLibrary_StatusCode {
    return new CQLLibrary_StatusCode().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): CQLLibrary_StatusCode {
    return new CQLLibrary_StatusCode().fromJsonString(jsonString, options);
  }

  static equals(a: CQLLibrary_StatusCode | PlainMessage<CQLLibrary_StatusCode> | undefined, b: CQLLibrary_StatusCode | PlainMessage<CQLLibrary_StatusCode> | undefined): boolean {
    return proto3.util.equals(CQLLibrary_StatusCode, a, b);
  }
}
 ...
 *
 * @generated from message google.fhir.r4.core.CQLLibrary.SubjectX
 */
export class CQLLibrary_SubjectX extends Message<CQLLibrary_SubjectX> {
  /**
   * @generated from oneof google.fhir.r4.core.CQLLibrary.SubjectX.choice
   */
  choice: {
    /**
  ...
  constructor(data?: PartialMessage<CQLLibrary_SubjectX>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.CQLLibrary.SubjectX";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): CQLLibrary_SubjectX {
    return new CQLLibrary_SubjectX().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): CQLLibrary_SubjectX {
    return new CQLLibrary_SubjectX().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): CQLLibrary_SubjectX {
    return new CQLLibrary_SubjectX().fromJsonString(jsonString, options);
  }

  static equals(a: CQLLibrary_SubjectX | PlainMessage<CQLLibrary_SubjectX> | undefined, b: CQLLibrary_SubjectX | PlainMessage<CQLLibrary_SubjectX> | undefined): boolean {
    return proto3.util.equals(CQLLibrary_SubjectX, a, b);
  }
}
