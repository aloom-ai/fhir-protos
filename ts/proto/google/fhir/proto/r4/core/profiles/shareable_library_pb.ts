...
// @generated from file proto/google/fhir/proto/r4/core/profiles/shareable_library.proto (package google.fhir.r4.core, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message google.fhir.r4.core.ShareableLibrary
 */
export class ShareableLibrary extends Message<ShareableLibrary> {
  /**
  ...
  /**
   * @generated from field: google.fhir.r4.core.ShareableLibrary.StatusCode status = 16;
   */
  status?: ShareableLibrary_StatusCode;
  ...
  /**
   * @generated from field: google.fhir.r4.core.ShareableLibrary.SubjectX subject = 19;
   */
  subject?: ShareableLibrary_SubjectX;
  ...
  constructor(data?: PartialMessage<ShareableLibrary>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.ShareableLibrary";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 16, name: "status", kind: "message", T: ShareableLibrary_StatusCode },
    { no: 17, name: "experimental", kind: "message", T: Boolean },
    { no: 18, name: "type", kind: "message", T: CodeableConcept },
    { no: 19, name: "subject", kind: "message", T: ShareableLibrary_SubjectX },
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ShareableLibrary {
    return new ShareableLibrary().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ShareableLibrary {
    return new ShareableLibrary().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ShareableLibrary {
    return new ShareableLibrary().fromJsonString(jsonString, options);
  }

  static equals(a: ShareableLibrary | PlainMessage<ShareableLibrary> | undefined, b: ShareableLibrary | PlainMessage<ShareableLibrary> | undefined): boolean {
    return proto3.util.equals(ShareableLibrary, a, b);
  }
}
 ...
 *
 * @generated from message google.fhir.r4.core.ShareableLibrary.StatusCode
 */
export class ShareableLibrary_StatusCode extends Message<ShareableLibrary_StatusCode> {
  /**
  ...
  constructor(data?: PartialMessage<ShareableLibrary_StatusCode>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.ShareableLibrary.StatusCode";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ShareableLibrary_StatusCode {
    return new ShareableLibrary_StatusCode().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ShareableLibrary_StatusCode {
    return new ShareableLibrary_StatusCode().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ShareableLibrary_StatusCode {
    return new ShareableLibrary_StatusCode().fromJsonString(jsonString, options);
  }

  static equals(a: ShareableLibrary_StatusCode | PlainMessage<ShareableLibrary_StatusCode> | undefined, b: ShareableLibrary_StatusCode | PlainMessage<ShareableLibrary_StatusCode> | undefined): boolean {
    return proto3.util.equals(ShareableLibrary_StatusCode, a, b);
  }
}
 ...
 *
 * @generated from message google.fhir.r4.core.ShareableLibrary.SubjectX
 */
export class ShareableLibrary_SubjectX extends Message<ShareableLibrary_SubjectX> {
  /**
   * @generated from oneof google.fhir.r4.core.ShareableLibrary.SubjectX.choice
   */
  choice: {
    /**
  ...
  constructor(data?: PartialMessage<ShareableLibrary_SubjectX>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "google.fhir.r4.core.ShareableLibrary.SubjectX";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ...
  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ShareableLibrary_SubjectX {
    return new ShareableLibrary_SubjectX().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ShareableLibrary_SubjectX {
    return new ShareableLibrary_SubjectX().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ShareableLibrary_SubjectX {
    return new ShareableLibrary_SubjectX().fromJsonString(jsonString, options);
  }

  static equals(a: ShareableLibrary_SubjectX | PlainMessage<ShareableLibrary_SubjectX> | undefined, b: ShareableLibrary_SubjectX | PlainMessage<ShareableLibrary_SubjectX> | undefined): boolean {
    return proto3.util.equals(ShareableLibrary_SubjectX, a, b);
  }
}
